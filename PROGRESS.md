...
| SD one-step dev env (`make dev`) | ⬜ planned | infra · S · compose Postgres + `.env.example` + `make dev/dev-down/dev-nuke` + smoke script · lands **before** the real-Sluice stop-and-use step · PLAN §SD |
